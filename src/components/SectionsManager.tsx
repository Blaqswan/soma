...
import { Plus, Trash2, Link2, Type, AlignLeft, HelpCircle } from "lucide-react";
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-bold text-zinc-400 dark:text-zinc-505 uppercase tracking-wider">
                  Section #{index + 1}
                </span>
                <button
                  onClick={() => onRemoveSection(section.id)}
                  title="Delete Section"
                  className="p-1.5 text-zinc-400 hover:text-rose-600 dark:text-zinc-505 dark:hover:text-rose-400 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors"
                >
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full pl-9 pr-4 py-2 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-xs font-medium text-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg text-xs font-medium text-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                  />
                </div>
              </div>
            </div>
